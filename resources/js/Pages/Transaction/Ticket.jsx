...
export default function Ticket({transaction, ticket}) {
                ...
                <article
                    ...
                    <div className="pt-3 mx-4 mb-4">
                        <h2 className="text-3xl font-bold text-gray-100">
                            Ticket for: {ticket.user.name} | {ticket.user.age}
                        </h2>
                        <div className="mt-6 mb-10 space-y-3">
                            ...
                            <p className="text-gray-100 p-2 border border-gray-100 rounded font-semibold text-lg">Total cost: <span
                                className="font-bold">{formatCurrency.format(transaction.total_cost)}</span></p>
                        </div>
                    </div>
                </article>
            </div>
