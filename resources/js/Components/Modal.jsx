        ...
        state ? (
            <div className="fixed inset-0 z-10 overflow-y-auto">
                ...
                <div className="flex items-center min-h-screen px-4 py-8">
                    <div className="relative w-full max-w-lg mx-auto bg-gray-100 rounded-md shadow-lg">
                        <div className="flex items-center justify-between p-4 border-b">
                            ...
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 mx-auto" viewBox="0 0 20 20"
                                     fill="currentColor">
